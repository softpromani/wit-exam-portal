                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach($students as $st)
                                <tr>
                                    <td><input type="checkbox" class="select-item" name="selected_students[]" value="{{$st->id}}">
                                    </td>
                                    <td>{{$loop->index + 1}}</td>
                                    <td>{{$st->registration_no}}</td>
                                    <td>
                                        <input type="text" value="{{ $st->university_roll_no }}" data-id="{{ $st->id }}"
                                            class="form-control roll-no-class" />
                                    ...
                                    <td>
                                        <a href="{{ route('reciept', $st->id) }}" class="btn btn-sm btn-primary"
                                            title="View Receipt">
                        ...
                        <tfoot>
                            <tr>
                                <th colspan="3"><button class="btn btn-danger" type="button" id="promote-btn">Promote Next
                                        Sem</button></th>
                            </tr>
                        </tfoot>
                    </table>
